...
fun runToTermTests() {
    ...
    expr = MultiplicativeExpression(multExpr1, multExpr1.inverse())
    ...
    expr = MultiplicativeExpression(simpleExpr1, multExpr1.inverse())
    ...
    val expr1 = MultiplicativeExpression(-simpleExpr2, multExpr1.inverse())
